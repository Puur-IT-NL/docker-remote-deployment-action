...
export DOCKER_HOST=ssh://$INPUT_REMOTE_DOCKER_HOST:$INPUT_SSH_PORT

DEPLOYMENT_COMMAND_OPTIONS="-p ${INPUT_PROJECT_NAME}"
...
env
echo "Command: ${DEPLOYMENT_COMMAND} ${DEPLOYMENT_COMMAND_OPTIONS} pull"
${DEPLOYMENT_COMMAND} ${DEPLOYMENT_COMMAND_OPTIONS} pull

echo "Command: ${DEPLOYMENT_COMMAND} ${DEPLOYMENT_COMMAND_OPTIONS} ${INPUT_ARGS}"
